// *(Вариант 1. Расчет произведения по формуле умножения матриц)
...
Console.Write("Введите количество столбцов 1-й матрицы, равное количеству строк 2-й матрицы: ");
int l = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите количество строк 2-й матрицы, равное количеству столбцов 1-й матрицы: ");
